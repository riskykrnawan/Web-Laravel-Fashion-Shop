  ...
  <table class="table table-striped table-sm">
    ...
    <tbody class="">
      ...
      <tr>
        ...
        <th scope="col">Rp. 250.000,00</th>
        <!-- <th scope="col">Rating</th> -->
        <!-- <th><a href="/admin/products/create"> <button class="btn btn-primary rounded-pill px-3 float-end mb-3">Buy</button></a> </th> -->
        <!-- <th scope="col">Stock</th>
        <th scope="col">Price</th>
        <th scope="col">Sold</th>
        <th scope="col">Created at</th>
            ...
            <div class="btn-group dropend pointer" role="button">
              ...
              <ul class="dropdown-menu">
                ...
                @if ($item->sold == 0)
                  ...
                  <li><a class="dropdown-item" onclick='failedAlert()'><i class="bi bi-trash3-fill me-2"></i> Delete</a></li>
                @endif
                <li><a class="dropdown-item" href="/admin/products/edit/{{ $item->id }}"><i class="bi bi-bag-fill"></i> &ensp;Buy</a></li>
              </ul>
            </div>
          </td>
      </tr>
